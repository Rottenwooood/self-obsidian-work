...
![1](ai-self-learning-main/从python开始的ai学习/深度学习%20pytorch/9.%20模型创建步骤与nn.Module/pcs/1.png "1")

一个nn.Module可以包含很多个子Module, 比如LeNet这个模块，包含了两个卷积层，两个池化层，以及三个全连接层

![2](ai-self-learning-main/从python开始的ai学习/深度学习%20pytorch/9.%20模型创建步骤与nn.Module/pcs/2.png "2")

计算图如下，计算图中两个概念要注意，一个是结点，也就是数据，另一个是边，也就是运算

![3](ai-self-learning-main/从python开始的ai学习/深度学习%20pytorch/9.%20模型创建步骤与nn.Module/pcs/3.png "3")

### 2. 模型构建两要素

![4](ai-self-learning-main/从python开始的ai学习/深度学习%20pytorch/9.%20模型创建步骤与nn.Module/pcs/4.png "4")
...
![5](ai-self-learning-main/从python开始的ai学习/深度学习%20pytorch/9.%20模型创建步骤与nn.Module/pcs/5.png "5")
...
![6](ai-self-learning-main/从python开始的ai学习/深度学习%20pytorch/9.%20模型创建步骤与nn.Module/pcs/6.png "6")
...
![7](ai-self-learning-main/从python开始的ai学习/深度学习%20pytorch/9.%20模型创建步骤与nn.Module/pcs/7.png "7")