...
![1](docs/折叠/待整理/知识库/计算机和硬件/折叠/ai-self-learning-main/从python开始的ai学习/深度学习%20pytorch/6.数据预处理：transforms模块机制/pcs/1.png "1")

torchvision.transforms：常用的图像预处理方法

![2](docs/折叠/待整理/知识库/计算机和硬件/折叠/ai-self-learning-main/从python开始的ai学习/深度学习%20pytorch/6.数据预处理：transforms模块机制/pcs/2.png)
...
![3](docs/折叠/待整理/知识库/计算机和硬件/折叠/ai-self-learning-main/从python开始的ai学习/深度学习%20pytorch/6.数据预处理：transforms模块机制/pcs/3.png "3")
